...
### ~~<mark style="color:red;">Zombie Heavy</mark>~~

~~<mark style="color:yellow;">**-Only visually changed; changes the Zombie Heavy to a dark blue color upon enzyme usage.**</mark>** **_**(No longer has fancy particles on wind up.)**_~~
